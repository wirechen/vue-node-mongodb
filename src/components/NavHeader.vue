...
<script>
    ...
    export default{
        ...
        methods:{
            checkLogin(){
                axios.get("/imooc/users/checkLogin").then((response)=>{
...
//                      this.nickName = res.result;
            ...
            logOut(){
                axios.post("/imooc/users/logout").then((response)=>{
                    let res = response.data;
                    if(res.status=="0"){
//                        this.nickName = '';
                        this.$store.commit("updateUserInfo",res.result.userName);
            ...
            getCartCount(){
              axios.get("/imooc/users/getCartCount").then(res=>{
                var res = res.data;
